...
def boxes_to_corners_3d(boxes3d):
    ...
    corners3d = boxes3d[:, None, 3:6].repeat(1, 8, 1) * template[None, :, :]   # change_shape
    corners3d = rotate_points_along_z(corners3d.view(-1, 8, 3), boxes3d[:, 6]).view(-1, 8, 3)   # rotate
    corners3d += boxes3d[:, None, 0:3]   # move box
